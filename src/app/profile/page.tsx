...
import { getDetailBook } from "../lib/cms-micro/client";
...
export default async function ProfilePage() {
    ...
    if (user) {
        ...
        purchaseDetailBooks = await Promise.all(purchasesData.map(async (purchase: Purchase) => {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="flex items-center gap-6">
                {
                    purchaseDetailBooks.map((detailBook: BookType) => (
                        <PurchaseDetailBook key={detailBook.id} purchaseDetailBook={detailBook}/>
